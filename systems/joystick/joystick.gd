...
## A simple virtual joystick for touchscreens mobile devices, with useful options.
## Made by SavhaSuvhe, free to use on your projects

@export_group("References")
## Used to change the Joystick's base image
@export var TextureBase: Texture
## Used to chsnge the joystick's tip Image
@export var TextureTip: Texture

@export_group("Misc")
## Used to visually display the joystick's base image ingame
@export var show_base := true

## Used to visually display the joystick's tip image ingame
@export var show_tip := true
...
func _update_visuals() -> void:
	if TextureBase: _base.texture = TextureBase
	if TextureTip: _tip.texture = TextureTip 
	
	_tip.visible = show_tip
	_base.visible = show_base
